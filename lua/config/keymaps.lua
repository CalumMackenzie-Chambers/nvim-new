...
local project_runner = require('util.project_runner')

vim.keymap.set('n', '<leader><leader>', project_runner.show_run_menu, {
  noremap = true,
  silent = true,
  desc = 'Show project run menu'
})

vim.keymap.set('n', '<leader>rd', project_runner.run_default, {
  noremap = true,
  silent = true,
  desc = 'Run default project command'
})

vim.keymap.set('n', '<leader>rc', project_runner.create_example_config, {
  noremap = true,
  silent = true,
  desc = 'Create example run config'
})
